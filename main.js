...
let names = ["Muhammad", "Zeeshan", "Rehman", "Nadeem"];
...
let friendNames = ["Muhammad", "Zeeshan", "Rehman", "Nadeem"];
...
let current_users = ["mudassar ali", "aman", "hamza", "bilal", "suleman"];
